...
export default function ComiteLogin() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    const res = await fetch("/api/comite/auth", {
      method: "POST",
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-10">
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-uai-navy rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-blue-950/20">
              <Shield className="w-8 h-8 text-uai-gold" />
            </div>
            <h1 className="text-2xl font-bold text-uai-navy mb-1">Miembro del Comité</h1>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 pr-11"
                  required
                />
                <button
                  type="button"
