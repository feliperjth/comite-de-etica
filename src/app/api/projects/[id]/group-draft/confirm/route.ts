...
export async function POST(
  ...
  if (overall === "accepted") {
    ...
    if (macarenaEmail) {
      await sendEmail(macarenaEmail, `Solicitud certificado de ética · ${project.title}`, buildMacarenaEmail(project, origin, generateCertToken(id)), project.researcher_email);
    }
  } else {
